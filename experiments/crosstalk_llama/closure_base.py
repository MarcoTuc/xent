...
Training llama3.2-1B base on 3e6 closure samples generated by GPT2
...
model_version = "M0"
new_model_base = "crosstalk-llama"
new_model_name = "llama-3.2-1B-base2closure"
...
batch_size = 1 #data per training step
