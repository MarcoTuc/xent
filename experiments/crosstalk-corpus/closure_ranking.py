...
Training GPT2-base2ranking on 3e6 closure samples, will we see again a degradation in performance?
...
experiment_name = "ranking2closure"
wandb_name = f"{project_name}_{experiment_name}_{launched_on}"

# define model to train
base_model = "crosstalk-cluster"
model_name = "gpt2"
model_version = "gpt2-base2ranking"
new_model_version = "gpt2-ranking2closure"
